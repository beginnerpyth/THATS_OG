...
class Service():
    def get_id(self,id:int):
        ...
        raise HTTPException(status_code=402,detail='data not here')
    ...
    def update_data(self,update_layout:student_update):
          check_data_update=self.get_id(id)
          ...
          raise HTTPException(status_code=403,detail=(f'this data{fake_student_db[id]} doesnt even exist'))
